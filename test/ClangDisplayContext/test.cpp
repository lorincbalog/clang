...
// RUN: %clang_display_context -line=105 -column=5 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 | FileCheck -check-prefix=CHECK-LAMBDA1 %s
// RUN: %clang_display_context -line=105 -column=30 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 | FileCheck -check-prefix=CHECK-LAMBDA2 %s

// Test invalid input parameters.
// RUN: not %clang_display_context -line=-1 -column=30 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 2>&1 | FileCheck -check-prefixes=CHECK-INVALID-LINE %s
// RUN: not %clang_display_context -line=105 -column=-1 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 2>&1 | FileCheck -check-prefix=CHECK-INVALID-COL %s
// RUN: not %clang_display_context -line=-1 -column=-1 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 2>&1 | FileCheck -check-prefixes=CHECK-INVALID-LINE,CHECK-INVALID-COL %s
// RUN: %clang_display_context -line=500000 -column=30 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 | FileCheck -check-prefix=CHECK-INVALID %s
// RUN: %clang_display_context -line=105 -column=500000 %S/Inputs/test.cpp -- %clang_cc1 -std=c++11 | FileCheck -check-prefix=CHECK-INVALID %s
